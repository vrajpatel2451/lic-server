    ...
    <div className="flex w-full py-10 items-start h-full">
      ...
      <div className="flex-1 flex flex-col gap-4 p-10 h-full">
        ...
        <div className="w-full flex items-stretch gap-4">
          ...
          <Link to={'/logs/admin'}>
            <p className="px-4 h-10 bg-pri-dark border-none flex items-center justify-center rounded-md text-white">
              See Logs
            </p>
          </Link>
          <button
            ...
            className="w-20 h-10 bg-pri border-none flex items-center justify-center rounded-md"
          >
