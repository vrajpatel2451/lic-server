  ...
  if (pathname !== '/login') {
    return (
      <div className="fixed top-0 left-0 w-[20%] h-screen z-10 bg-pri-dark p-4 flex flex-col items-stretch gap-4">
        ...
        <div
          onClick={() => navigate('/')}
          className={`flex items-center gap-2 py-4 rounded-md hover:bg-pri cursor-pointer ${
            pathname === '/' ? 'bg-pri' : ''
          }`}
        >
        ...
        <div
          ...
          className={`flex items-center gap-2 py-4 rounded-md hover:bg-pri cursor-pointer ${
            pathname.includes('/client') ? 'bg-pri' : ''
          }`}
        >
          <span className="w-[20%] flex justify-center items-center">
        ...
        <div
          ...
          className={`flex items-center gap-2 py-4 rounded-md hover:bg-pri cursor-pointer ${
            pathname.includes('/staff') ? 'bg-pri' : ''
          }`}
        >
          <span className="w-[20%] flex justify-center items-center">
        ...
        <div
          ...
          className={`flex items-center gap-2 py-4 rounded-md hover:bg-pri cursor-pointer ${
            pathname.includes('/admin') ? 'bg-pri' : ''
          }`}
        >
          <span className="w-[20%] flex justify-center items-center">
        ...
        <div
          ...
          className={`flex items-center gap-2 py-4 rounded-md hover:bg-pri cursor-pointer ${
            pathname.includes('/account') ? 'bg-pri' : ''
          }`}
        >
          <span className="w-[20%] flex justify-center items-center">
        ...
        <div className="flex-1 flex items-end">
          <button
            ...
            className="flex w-full items-center gap-4 justify-center p-4 bg-pri bg-blend-darken rounded-md"
          >
